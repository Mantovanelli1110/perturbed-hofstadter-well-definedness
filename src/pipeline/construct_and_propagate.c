...
/* ------------------------------------------------------------ */
/*
 * Embedded symbolic trace used for reconstruction.
 *
 * This trace was generated by simulating the perturbed Hofstadter recursion
 * up to dyadic level m = 36 and extracting the corresponding 5-state path
 * and E-code decomposition.
 *
 * It is included here as a fixed, deterministic input to make the pipeline
 * self-contained and reproducible.
 *
 * The original trace can also be found in:
